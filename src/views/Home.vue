<template>
  <div class="home">
    ...
    <h4>Smaller Display</h4>
    <h4 class="display-1">Smaller Display</h4>
    <p class="text-h1">This is a headline</p>
    <p class="subtitle-2">This is a subheading</p>
    <p class="subtitle-2 font-weight-bold">This is a subheading</p>
    <p class="caption">This is a caption</p>

    <v-btn class="pink white--text">click me</v-btn>
    <v-btn depressed color="pink" dark>click me</v-btn>
    <v-btn plain color="pink">click me</v-btn>

    <v-btn depressed color="pink" dark>
